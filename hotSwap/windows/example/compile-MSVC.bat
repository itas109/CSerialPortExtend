...
rem release compile
cl /Zi /nologo /W3 /WX- /O2 /Oi /Oy- /GL /D WIN32 /D NDEBUG /D _CONSOLE /D _LIB /D _UNICODE /D UNICODE /Gm- /EHsc /MD /GS /Gy /fp:precise /Zc:wchar_t /Zc:forScope /Gd /TP /I "..\src" ..\src\CSerialPortHotSwap.cpp main.cpp /link /OUT:"CSerialPortHotSwap-MSVC.exe" /INCREMENTAL /NOLOGO user32.lib /SUBSYSTEM:CONSOLE /MACHINE:X86
